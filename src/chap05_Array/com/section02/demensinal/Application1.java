package chap05_Array.com.section02.demensinal;

public class Application1 {
    public static void main(String[] args) {
        /* [ 다차원 배열 ] */
        /*
            다차원 배열은 2차원 이상의 배열을 의미하며, 배열의 인덱스 마다 또 다른 배열의 주소를 보관하는 배열이다.
        ...
        /*
            ...
            2. 여러개의 1차원 배열의 주소를 관리할 배열(heap)
        ...
        // 행의 갯수를 다르게 할 경우 쓰면 좋을듯?
        iarr1[0] = new int[3]; // [][][]
        iarr1[1] = new int[5]; // [][][][][]
        iarr1[2] = new int[7]; // [][][][][][][]

        /* 관리하는 여러개의 배열의 길이가 동일한 경우 아래와 같이 한번에 할당할 수 있다. */
        // 하지만 여러 개의 배열의 길이가 각각 다른 경우 위에 처럼 인덱스별로 배열을 따로 할당해 주어야 한다.
        // 1. 정변배열 : 서로 같은 길이의 여러 개 배열을 하나로 묶어서 관리하는 2차원 배열
        // 2. 가변배열 : 서로 길이가 같지 않은 여러 개의 배열을 하나로 묶어서 관리하는 2차원 배열
        iarr2 = new int[3][5];
