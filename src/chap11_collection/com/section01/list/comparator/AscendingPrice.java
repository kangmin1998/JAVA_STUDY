package chap11_collection.com.section01.list.comparator;
...
// Object 타입인 경우 다운케스팅 해서 사용해야 하므로 제네릭 타입을 결정해주고 사용하는 것이 좋다.
public class AscendingPrice implements Comparator<BookDTO> {
    ...
    public int compare(BookDTO o1, BookDTO o2) {
        ...
        /*
            가격이 오름차순 정렬이 되기 위해서는 앞의 가격이 더 작은 가격이여야 한다.
            만약 뒤의 가격이 더 작은 경우 인스턴스의 순서를 바꾸어야 한다.
