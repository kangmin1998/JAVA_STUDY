package chap01_literal_and_variable.com.section03.constant;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        final int AGE;  // 상수의 변수명은 대부분 대문자로 한다.

        //초기화
        AGE = 20;
//      AGE = 30;  // 한번 초기화 한 이후에 값을 재 대입하는 것은 불가능
